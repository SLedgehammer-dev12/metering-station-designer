...
with col_nav1:
    if st.button(t("requirements_back"), use_container_width=True):
        st.session_state.page = "process"
        st.rerun()
with col_nav2:
    if st.button(t("requirements_next_weights"), use_container_width=True):
        st.session_state.page = "weights"
        st.rerun()
with col_nav3:
    if st.button(t("requirements_calc"), use_container_width=True, type="primary"):
